    ...
    public partial class m1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientInRecipes", x => new { x.RecipeId, x.IngredientId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "IngredientInShoppingLists",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientInShoppingLists", x => new { x.ShoppingListId, x.IngredientId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientInShoppingLists_ShoppingLists_ShoppingListId",
